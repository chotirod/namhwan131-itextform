import 'package:flutter/material.dart' show AppBar, BorderRadius, BuildContext, CheckboxListTile, Column, Container, Divider, DropdownButton, DropdownMenuItem, EdgeInsets, Form, FormState, GlobalKey, Icon, Icons, InputDecoration, MainAxisAlignment, OutlineInputBorder, Padding, RadioListTile, RaisedButton, Scaffold, State, StatefulWidget, Text, TextEditingController, TextField, TextFormField, Widget;
...
class _HomePageState extends State<HomePage>{
  ...
  String _gender;
  //DropdoenButton
  List<String> dropdownltems = ['นาย','นาง','นางสาว','เด็กหญิง','เด็กชาย'];
